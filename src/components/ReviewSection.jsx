const ReviewSection = () => {
  return (
    <div className="mt-10">
     ...
     <div className="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-3 mt-10">
     <div className="container flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md divide-gray-700 bg-[#640D6B] border-[3px]  text-gray-100">
        <div className="flex justify-between p-4">
          <div className="flex space-x-4">
            ...
            <div>
              <h4 className="font-bold">Sakib Lionel Messi</h4>
              <span className="text-xs text-gray-400">7 days ago</span>
            </div>
          </div>
          <div className="flex items-center space-x-2 text-yellow-500">
            <svg
              xmlns="https://images.unsplash.com/photo-1667062672868-f1e128d4782e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzZ8fGZvcm1hbCUyMG1lcmFkb25hfGVufDB8fDB8fHww"
              viewBox="0 0 512 512"
